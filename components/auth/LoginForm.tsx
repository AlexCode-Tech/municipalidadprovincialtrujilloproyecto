...
import { AlertCircle, Building2, CreditCard, Eye, EyeOff, LockKeyhole, Mail, ShieldCheck, Store } from "lucide-react";
    ...
    async function checkAccountStatus() {
      ...
      try {
        ...
        if (resStatus.ok && active) {
          ...
          if (data.status === "INACTIVO" && (role as string) !== "ADMIN" && data.rol !== "ADMIN") {
            const roleText = roleConfig.find((r) => r.id === role)?.label || role;
